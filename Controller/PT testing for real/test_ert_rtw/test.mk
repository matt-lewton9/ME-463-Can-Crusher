...
## 
## Makefile     : test.mk
## Generated on : Thu Nov 13 21:50:58 2025
...
START_DIR                 = /Users/tak/Documents/GitHub/ME-463-Can-Crusher/Controller/PT\ testing\ for\ real
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = /Users/tak/Documents/MATLAB/R2025a/ArduinoStaticLibrary/ArduinoMega2560/FasterBuilds
SSLIB_PATH                = /Users/tak/Documents/MATLAB/R2025a/ArduinoStaticLibrary/ArduinoMega2560/FasterBuilds
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/mega -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/include -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/3P.instrset/arduinoide.instrset/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/3P.instrset/arduinoide.instrset/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/Wire/src/utility -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/3P.instrset/arduinoide.instrset/aCLI/data/packages/arduino/hardware/avr/1.8.3/libraries/SPI/src -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/3P.instrset/arduinoide.instrset/aCLI/user/libraries/Servo/src -I/Users/tak/Documents/MATLAB/SupportPackages/R2025a/3P.instrset/arduinoide.instrset/aCLI/user/libraries/Servo/src/avr
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_EXTMODE_SIMULATION_TIME_IN_TICKS -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=48 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=265 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
SRCS = /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c $(START_DIR)/test_ert_rtw/test.c $(START_DIR)/test_ert_rtw/test_data.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/scheduler/src/arduinoAVRScheduler.cpp /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/platform_timer.cpp /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/rtiostream_serial_daemon.cpp
...
OBJS = MW_arduinoI2C.o xcp_ext_mode.o test.o test_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_arduinoI2C.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


platform_timer.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/platform_timer.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtiostream_serial_daemon.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
