...
MAKECMD         = /Applications/MATLAB_R2025a.app/bin/maci64/gmake -j 4 -l 4
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = test
MODULES                 = MW_arduinoI2C.cpp rt_nonfinite.c test.c test_capi.c test_data.c test_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = test
MAKEFILE                = test.mk
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB_R2025a.app/bin/maci64 -Wl,-rpath,/Applications/MATLAB_R2025a.app/sys/os/maci64 -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB_R2025a.app/sys/os/maci64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include \
	-I$(START_DIR)/slprj/raccel/test \
...
MW_arduinoI2C.o : /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) /Users/tak/Documents/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp
