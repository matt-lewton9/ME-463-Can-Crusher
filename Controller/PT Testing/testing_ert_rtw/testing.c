...
void testing_step(void)
{
  ...
  testing_B.I2CRead_o2 = MW_I2C_MasterWrite
    (testing_DW.obj_g.I2CDriverObj.MW_I2C_HANDLE, 88UL, &output_raw, 1UL, true,
     false);
  if (testing_B.I2CRead_o2 == 0) {
    MW_I2C_MasterRead(testing_DW.obj_g.I2CDriverObj.MW_I2C_HANDLE, 88UL,
...
void testing_initialize(void)
{
  ...
  /* External mode info */
  testing_M->Sizes.checksums[0] = (1947984024U);
  testing_M->Sizes.checksums[1] = (3910086204U);
  testing_M->Sizes.checksums[2] = (228156755U);
  testing_M->Sizes.checksums[3] = (4224442377U);
